<template>
  <div class="container">
    ...
    <div class="bloco-botoes">
      <button @click="voltar" v-if="questaoAtual > 0">Voltar</button>
      <button @click="avancar" v-if="questaoAtual <= totalQuestoes">Avançar</button>
      <button @click="finalizar" v-if="questaoAtual == totalQuestoes + 1">Finalizar</button>
    </div>
  </div>
</template>
